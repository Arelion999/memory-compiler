...
**Тюнинг ранжирования** (`RRF_K`, `DECAY_WEIGHT`, `BM25_TITLE_B`/`BM25_TAGS_B`/`BM25_BODY_B`) — веса ВНУТРИ отобранного пула. Применяются на этапе запроса, эксперимент ≈ минута. Сетка: `scripts/eval_ranking.py`.
