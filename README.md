...
- **Semantic** — bi-encoder embeddings (`paraphrase-multilingual-MiniLM-L12-v2`), русский + английский
- **Cross-encoder reranking** — `BAAI/bge-reranker-base` пересортировывает топ-20 кандидатов для финального выбора (precision@3 +15-20%)
