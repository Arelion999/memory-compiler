...
**По умолчанию держи `content` около 1500 символов.** До ~4000 можно, когда текст
действительно неделимый: один сюжет — механизм, доказательства и решение по одной
теме. Если внутри несколько тем, это несколько статей, и дробить их надо
